...
class Solution {
    /**
     * 贪心：
     * 1. 先按照身高从大到小排序。若身高相等，按照第二维进行从小到大排序
     * 2. 遍历每个人，找到他应该在的位置。这里局部贪心的思想是：的每个人站到k的下标处，因为已经按照身高排序了，所以他前面的人都比他高，那么可以直接站在下标为k处，那么前面就又k个比他高的人
     * @param people
     * @return
     */
    public int[][] reconstructQueue(int[][] people) {
        LinkedList<int[]> queue = new LinkedList<>();//用链表操作时间更少
